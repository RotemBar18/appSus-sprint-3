export class ReadMoreReadLess extends React.Component {
    ...
    render() {
        ...
        return <section>
            <p>
                ...
                {isOver100 && <button className="txt-show-btn" onClick={this.onToggleShow}>{isLongShown ? 'Show Less' : 'Show More'}</button>}
            </p>
        </section>
    }
